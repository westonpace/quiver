 ...
 public:
  ...
  Status ReserveChunkAt(int64_t offset, int64_t len, SinkBuffer* out) override {
    ...
    if (offset + len > static_cast<int64_t>(data_.size())) {
      return Status::Invalid("Attempted to write past end of RAM sink.  Offset=", offset,
...
class RamStorage : public Storage {
 public:
  ...
  [[nodiscard]] bool in_memory() const override { return true; }
...
class FileStorage : public Storage {
 public:
  ...
  [[nodiscard]] bool in_memory() const override { return false; }
